...
import in.alexsoft.rc.music.widgetButtonVoldown.Log;
...
public class widgetButtonMasterVoldown extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetmastervoldown);

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonMasterVoldown.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonvoldown, actionPendingIntent);
