...
public class widgetButtonPlay extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetplay );

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonPlay.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonplay, actionPendingIntent);
