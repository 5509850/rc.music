...
public class widgetButtonPrev extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetprev);

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonPrev.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonprev, actionPendingIntent);
