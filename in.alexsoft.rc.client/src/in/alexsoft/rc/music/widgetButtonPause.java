...
import in.alexsoft.rc.music.widgetButtonPlay.Log;
...
public class widgetButtonPause  extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetpause );

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonPause.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonpau, actionPendingIntent);
