...
public class widgetButtonVolup extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetvolup);

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonVolup.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonvolup, actionPendingIntent);
