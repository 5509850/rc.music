...
import in.alexsoft.rc.music.widgetButtonOff.Log;
...
public class widgetButtonHibernate extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgethibernate);

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonHibernate.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonofficon, actionPendingIntent);
