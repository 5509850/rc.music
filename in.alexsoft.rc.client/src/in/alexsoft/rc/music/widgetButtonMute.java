...
public class widgetButtonMute  extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetmute );

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonMute.class);
       ...
       remoteViews.setOnClickPendingIntent(R.id.widgeticonmute, actionPendingIntent);
