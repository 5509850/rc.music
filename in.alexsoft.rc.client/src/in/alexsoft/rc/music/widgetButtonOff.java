...
public class widgetButtonOff extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetoff);

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonOff.class);
