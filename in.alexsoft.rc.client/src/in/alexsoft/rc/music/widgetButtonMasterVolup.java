...
import in.alexsoft.rc.music.widgetButtonVolup.Log;
...
public class widgetButtonMasterVolup  extends  AppWidgetProvider {
  ...
  public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
       ...
       RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.widgetmastervolup);

       //Подготавливаем Intent для Broadcast
       Intent active = new Intent(context, widgetButtonMasterVolup.class);
       active.setAction(ACTION_WIDGET_RECEIVER);
       active.putExtra("msg", "Hello alexsoft");

       //создаем наше событие
       PendingIntent actionPendingIntent = PendingIntent.getBroadcast(context, 0, active, 0);

       //регистрируем наше событие
       remoteViews.setOnClickPendingIntent(R.id.widgeticonmastervolup, actionPendingIntent);
